...
import com.codebay.EjercicioApi.Juego;
import com.codebay.EjercicioApi.Jugable;
...
public class JuegoAhorcado extends Juego implements Jugable{
	...
	public void setStringToGuess(String stringToGuess){
		for(int i = 0; i < stringToGuess.length(); i++){
			if(Character.isDigit(stringToGuess.charAt(i))){
				ExceptionGame exception = new ExceptionGame("Solo se permiten caracteres");
				System.out.println("CHACHO LOCOOOOOOO");
			}
		}
